...
/* harmony export */   "default": function() { return /* binding */ MessageView; }
/* harmony export */ });
class MessageView {
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/dist/esm5/internal/operators/switchMap.js");
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/dist/esm5/internal/operators/concatAll.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/dist/esm5/internal/operators/filter.js");
/* harmony import */ var _MessageView__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MessageView */ "./src/js/MessageView.js");
...
class Messages {
  ...
  getMessage() {
    ...
    const oldMessages = [];
    (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.interval)(2000).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.switchMap)(() => rxjs_ajax__WEBPACK_IMPORTED_MODULE_3__.ajax.getJSON(url).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.map)(response => [...response.messages]), (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.catchError)(error => {
      // eslint-disable-next-line no-console
      console.log('error: ', error);
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_6__.of)(error);
    }))), (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.concatAll)(), (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.filter)(value => !oldMessages.includes(value.received))).subscribe(message => {
  ...
  reflectMessages(message) {
    ...
    this.messagesContainer.insertAdjacentHTML('afterbegin', _MessageView__WEBPACK_IMPORTED_MODULE_0__["default"].markup(message.from, message.subject, time));
  }
}
...
const messages = new _Messages__WEBPACK_IMPORTED_MODULE_0__["default"](app);
messages.render();
